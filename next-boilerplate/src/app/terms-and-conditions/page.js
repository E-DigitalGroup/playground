...
export const metadata = generateSEO('terms-and-conditions');
					...
					<div className="row">
						<div className="col-lg-8 mx-auto">
							...
							<p>
								...
								"terms") carefully before using www.e-digitalgroup.com website
								(“website”, "service") operated by E-Digital Group, Inc ("us",
								'we", "our").
							</p>
							...
							<p>
								...
								Agreement, you are advised to stop using the website
								accordingly. E-Digital Group, Inc only grants use and access of
							...
							<p>
								...
								Agreement. E-Digital Group, Inc assumes no responsibility for
								liabilities related to age misrepresentation.
							</p>
							<h2>Intellectual property</h2>
							<p>
								You agree that all materials, products, and services provided on
								this website are the property of E-Digital Group, Inc, its
								...
								agree that you will not reproduce or redistribute the Mile-Hi
								Skydiving's intellectual property in any way, including
								electronic, digital, or new trademark registrations.
							</p>
							<p>
								You grant E-Digital Group, Inc a royalty-free and non-exclusive
							...
							<p>
								By using this website, you agree that the laws of the
								California, without regard to principles of conflict laws, will
								govern these terms and conditions, or any dispute of any sort
								that might come between E-Digital Group, Inc and you, or its
							...
							<p>
								...
								federal court California and you consent to exclusive
								jurisdiction and venue of such courts.
							</p>
							<h2>Indemnification</h2>
							<p>
								You agree to indemnify E-Digital Group, Inc and its affiliates
								and hold E-Digital Group, Inc harmless against legal claims and
								demands that may arise from your use or misuse of our services.
								We reserve the right to select our own legal counsel.{' '}
							</p>
							<h2>Limitation on liability</h2>
							<p>
								E-Digital Group, Inc is not liable for any damages that may
								occur to you as a result of your misuse of our website.
							</p>
							<p>
								E-Digital Group, Inc reserves the right to edit, modify, and
								...
								understanding between E-Digital Group, Inc and the user, and
