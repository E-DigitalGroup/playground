...
export default function Home() {
	//https://www.termsfeed.com/live/7f9014a6-dc9c-47ce-b325-d4d12fb9223e
	return (
		<>
				...
				<div className="container-xl ">
					<div className="row">
						<div className="col-lg-8 mx-auto">
							...
							<ul>
								...
								<li>
									<p>
										...
										E-Digital Group, Inc LLC, 8700 St Vrain Rd, Longmont, CO
										80503, United States.
									</p>
								</li>
								<li>
								...
								<li>
									<p>
										<strong>Website</strong> refers to E-Digital Group, Inc,
										accessible from{' '}
										<a
											href="https://www.e-digitalgroup.com"
											rel="external nofollow noopener"
											target="_blank"
										>
											https://www.e-digitalgroup.com
										</a>
									</p>
								</li>
								<li>
							...
							<ul>
								<li>
									<p>By email: info@e-digitalgroup.com</p>
								</li>
								<li>
									<p>By phone number: +1.646.290.1967</p>
								</li>
							</ul>
						</div>
					</div>
